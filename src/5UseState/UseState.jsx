...
// On every render, React expects:

// hook #1 → same hook as before

// hook #2 → same hook as before

// hook #3 → same hook as before
...
// The same hooks must be called in the same order, every render
...
// useState is a Hook in React that lets functional components have state/ Data.
...
// 2️⃣ Syntax ====> const [state, setState] = useState(initialValue);
...
// _______________________🟢 useState Internal Flow — Detailed Terminal Diagram______________________
...
//(3) Functional Updates for efficiency
